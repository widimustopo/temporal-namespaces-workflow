...
type Product struct {
	ProductID    string  `json:"product_id" gorm:"primary_key; unique;type:uuid; column:product_id;default:uuid_generate_v4()"`
...
type Member struct {
	MemberID   string `json:"member_id" gorm:"primary_key; unique;type:uuid; column:member_id;default:uuid_generate_v4()"`
	MemberName string `json:"member_name" validate:"required"`
}

type Payment struct {
	PaymentID     string  `json:"payment_id" gorm:"primary_key; unique;type:uuid; column:payment_id;default:uuid_generate_v4()"`
